...
"folio.return": "简洁版主页",
"folio.tagline": "写点代码，保持好奇。",
"folio.browse": "看看我的项目",
"folio.profilefoot": "互联网里的一个小小据点。",
"folio.aboutlabel": "关于我",
"folio.hello": "你好，我是 EpochTX。",
"folio.intro": "我关注 AI 工作流与现代 Web，也喜欢把日常遇到的小问题，做成自己用得上的工具。",
"folio.intro2": "从看看天气，到查查网络，这里收集着我的一些小折腾。屏幕之外的日常，也留了一个小角落。",
"folio.note": "有想法、建议，或者只是想打个招呼，都欢迎来信。",
"folio.weathertitle": "观天",
"folio.weatherdesc": "把不同来源的天气放在一起看。",
"folio.networktitle": "NET SIGHT · IP 查询",
"folio.networkdesc": "查询 IP、网络信息与地图，一个页面就够。",
"folio.drawtitle": "幸运抽签",
"folio.drawdesc": "列表、数字与权重抽签，帮日常做个小决定。",
"folio.selected": "项目精选",
"folio.all": "全部项目 ↗",
"folio.now": "最近在做",
"folio.nowtitle": "一点点打磨。",
"folio.nowcopy": "整理这个小站，也慢慢打磨这里的工具。",
"folio.github": "去 GitHub 逛逛 ↗",
"folio.life": "生活的一小片。",
"folio.lifecopy": "给值得留下的片刻，留个位置。照片以后慢慢添。",
"folio.album": "走进相册 ↗",
"folio.viewcopy": "同一个小站，换个视角。",
"folio.view": "全景版主页 ↗",
"folio.interests": "兴趣与探索",
"folio.tools": "日常工具",
"folio.curiosity": "新鲜想法",
